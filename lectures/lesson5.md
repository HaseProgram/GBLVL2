...
Чтобы это сделать, вебпак должен при сборке загружать наши файлы каким-то специальным способом, а именно, прогоняя их через транскомпилятор. Это сделать можно используя лоадеры.
